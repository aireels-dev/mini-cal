...
- 🐛 **报告 Bug**：[提交 Issue](https://github.com/minical/minical/issues)
- 💡 **功能建议**：[提交想法](https://github.com/minical/minical/discussions)
- 🌍 **翻译**：帮助翻译到更多语言
- 🎨 **主题**：设计并分享自定义主题
- 💻 **代码**：提交 Pull Request
...
- 💭 **讨论**：[GitHub Discussions](https://github.com/minical/minical/discussions)
